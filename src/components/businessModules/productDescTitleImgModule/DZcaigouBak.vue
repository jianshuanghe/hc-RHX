      ...
      >
        <ul class="dingzhi-caigou-ul">
          <li class="dingzhi-caigou-li">
            ...
            <div class="dingzhi-caigou-text">
              <cube-button @click="showMutiPicker(index)">{{item.key == "undefinedundefined"?'请选择':item.key}}</cube-button>
            </div>
...
export default {
  ...
  methods: {
    ...
    selectHandle(selectedVal, selectedIndex, selectedText) {
      this.mi_title_stitle_img.dataList[this.index].key = selectedVal.join('')
      // this.$createDialog({
      //   type: 'warn',
