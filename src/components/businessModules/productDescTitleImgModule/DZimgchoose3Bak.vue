<template>
  <div class="PDTIV1 dingzhi-base bg-fff" v-if="renderThis">
    ...
    <textarea :class="{'dingzhi-head':true, 'text': editable}" maxlength="5" :disabled="!editable" v-model="mi_title_stitle_img.title"></textarea>
    <textarea :class="{'dingzhi-addimg-ms':true, 'text': false}" maxlength="20" disabled="true" v-model="mi_title_stitle_img.content"></textarea>
