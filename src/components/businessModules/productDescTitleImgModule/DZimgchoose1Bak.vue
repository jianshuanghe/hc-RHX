    ...
    <transition-group name="list-complete" tag="div" mode="in-out" class="flex">
      ...
      >
        <div class="dingzhi-tupianC-div">
          <img class="defaultImg" :src="item.imgUrl || 'http://style.iambuyer.com/img/rhx-mobile-normal@2x.png'" alt="img" @click.prevent="showChoseImgBtns">
        ...
        <div class="mi_itemConWrap MITEMS">
          <div class="mi_itemConWrap_imgWrap">
            <changeImgTips @change-img="changeImg(item,'imgUrl')"
                           @remove-img="removeImg(item,'imgUrl')" :choseimgfile="choseimgfile" v-if="show.isChoseImg">
            </changeImgTips>
