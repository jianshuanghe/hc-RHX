  ...
  <div class="PDTIV1" v-if="renderThis">
    ...
    <transition-group name="list-complete" tag="div" mode='in-out' >
      <section
        ...
        :key="index" class="MITEMS-WRAP list-complete-item notop"
      >
        ...
        <div class="mi_itemConWrap MITEMS" v-show="item.imgUrl">
          <div class="mi_itemConWrap_imgWrap">
            ...
            <img :src="item.imgUrl || 'http://style.iambuyer.com/img/rhx-mobile-normal@2x.png'" alt="" class="needsclick order-banner-img" @click.prevent="showChoseImgBtns(item,index)">
          </div>
        </div>
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  ...
  .img-all .img-null .imgBox{
    position:relative;
    width:17%;
    margin: 0 auto;
  }
  .img-all .img-null .imgBox>img{
    position :relative;
    width: 100%;
  }
  .img-all .img-null .p-box{
    position:relative;
    width:100%;
  }
  .img-all .img-null .p-box>p{
    position:relative;
    width:100%;
    font-size: 3.5vw;
    line-height: 15vw;
