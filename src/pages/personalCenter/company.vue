    ...
    <div class="editPerInfo">
        ...
        <div class="perInfoCont">
            <div class="perInfoItem first">
                <div>
                    <cube-upload
                        ...
                        <div class="clear-fix companyImg">
                            <cube-upload-file class="touImg" v-for="(file, i) in files" :file="file" :key="i"></cube-upload-file>
                            <cube-upload-btn :multiple="false">
                            <div>
                                <img class="defaultImg" :src="form.compLogo || 'http://style.iambuyer.com/img/rhx-mobile-normal@2x.png'" alt="img">
                                <!-- <i>＋</i> -->
                                <p v-if="!form.compLogo">上传公司logo</p>
                            </div>
                            </cube-upload-btn>
                        </div>
                    </cube-upload>
            ...
            <div class="perInfoItem">
                <label class="perInfoItemL">公司名称</label>
                <div>
                    <input class="perInfoItemR" type="text" minlength="2" maxlength="20" v-model="form.companyName" placeholder="请输入公司名称">
                    <i class="iconfont icon-icon-arrow-right4"></i>
                </div>
            </div>
            <div class="perInfoItem">
                <label class="perInfoItemL">公司简介</label>
                <div>
                    <!-- <div class="perInfoItemR textarea" @click="showEdit=true">{{form.companyIntro}}</div> -->
                    <input class="perInfoItemR textarea" @click="showEdit=true" v-model="form.companyIntro" placeholder="请输入公司简介">
                    <i class="iconfont icon-icon-arrow-right4"></i>
                </div>
            </div>
            <div class="perInfoItem">
                ...
                <div>
                  ...
                  <input  type="text"  class="perInfoItemR textarea" placeholder="请输入您的联系地址" v-model="form.addressDetail" value="" />
        ...
        <div class="perInfoCont">
            <div class="perInfoItem" @click.self="kanEWM">
                ...
                <div>
                    <cube-upload
                        ...
                        <div class="clear-fix erweima">
                            ...
                            <cube-upload-btn :multiple="false">
                            <div>
                                <img class="defaultImg2" :src="form.wechatQrImg || 'http://style.iambuyer.com/img/rhx-mobile-normal@2x.png'" alt="img">
        ...
        <!-- 预览二维码 -->
        <div class="look-img" v-if="look" @click="kanEWM">
          <img :src="form.wechatQrImg" alt="">
        </div>
    </div>
</template>
...
.companyImg .cube-upload-file-def{
  width 100%
  height 100%
}
.companyImg{
...
export default {
  ...
  methods: {
    ...
    sucHandler2(file) {
      console.log("erweima")
      console.log(file)
      this.form.wechatQrImg = file.url;
    },
    // save
    save() {
